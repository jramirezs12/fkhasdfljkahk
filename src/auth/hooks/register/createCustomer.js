...
import { REGISTER_MUTATION } from '../../context/register/mutations';

export const createCustomer = async ({ email, firstname, lastname, otpCode, password, phoneNumber, roleId }) => {
    try {
