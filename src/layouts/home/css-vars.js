...
export function homeLayoutVars(theme) {
  return {
    ...
    '--layout-home-content-pt': theme.spacing(1),
    '--layout-home-content-pb': theme.spacing(8),
    '--layout-home-content-px': theme.spacing(5),
  };
}

// ----------------------------------------------------------------------

export function homeNavColorVars(theme, navColor = 'integrate', navLayout = 'vertical') {
  const {
    vars: { palette },
  } = theme;
