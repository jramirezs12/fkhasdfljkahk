...
export function AccountDocuments({ onSubmit, sx, ...other }) {
        ...
        <FormControlLabel
          ...
          label={
            <Typography variant="body2">
              Acepto términos y condiciones. Autorizo el tratamiento de mis datos personales para
              las finalidades descritas en la{' '}
